...
if($status_form==false){
 ...
 while($result_form_item = $stmt_form->fetch(PDO::FETCH_ASSOC)){
   ...
   if($result_form_item["form_type"] == "textarea"){
    ...
    $form_item_view .= '<div class="form-group" id="'.h($form_id_element).'">';
    $form_item_view .= '<label class="control-label" for="questions['.h($form_id_element).']">質問:</label>';
    $form_item_view .= '<textarea class="form-control" name="questions['.h($form_id_element).']" placeholder="質問文を入力してください。　　例）あなたの得意な科目はなんですか？複数選択可">'.$result_form_item["question"].'</textarea>';
    ...
    $form_item_view .= '<div class="form-group" id="'.h($form_id_element).'">';
    $form_item_view .= '<label class="control-label" for="questions['.h($form_id_element).']">質問:</label>';
    $form_item_view .= '<textarea class="form-control" name="questions['.h($form_id_element).']" placeholder="質問文を入力してください。　　例）あなたの血液型はなんですか？">'.$result_form_item["question"].'</textarea>';
    $form_item_view .= '<div class="text-right">';
