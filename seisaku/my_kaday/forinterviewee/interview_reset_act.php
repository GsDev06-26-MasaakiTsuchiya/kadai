...
$subject_text = "[smartinterview]".$res_interviewee_info["interviewee_name"]."様より面接についてご連絡";
$text = "";
$text .= $res_interviewee_info["interviewee_name"]."様より以下の内容で面接再調整の要望が参りました。".PHP_EOL;
$text .= "再調整の理由:".h($concel_reason).PHP_EOL;
$text .= "コメント:".h($comment).PHP_EOL;
$text .= "以下URLよりに日程の再調整ができます。".PHP_EOL;
$text .= $url_path.'setting/video_interview_resetting_01.php?interview_id='.$interview_id;
