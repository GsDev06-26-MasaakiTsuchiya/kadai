                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        <a class="btn btn-info" href="interview_confirm_insert.php?interview_id=<?= h($res["interview_id"]);?>&interview_date_time=<?= h($res["interview_reserve_time"]); ?>">確定</a>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="modal fade" id="myModal_cancel">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <a class="btn btn-danger" href="interview_cancel.php?interview_id=<?= h($_SESSION["interview_id"]); ?>">キャンセルして再設定</a>
                    </div>
                  </div>
                </div>
              </div>
