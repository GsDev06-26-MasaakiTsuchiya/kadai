...
<tr><th class="text-center">部門</th><td class="text-center"><?= h($res["devision_name"]) ?></td></tr>
<tr><th class="text-center">職種</th><td class="text-center"><?= h($res["position_name"]) ?></td></tr>
<tr><th class="text-center">タイトル</th><td class="text-center"><?= h($res["position_title"]) ?></td></tr>
<tr><th class="text-center">ステージ</th><td class="text-center"><?= $interview_type[h($res["interview_type"])] ?></td></tr>
<tr><th class="text-center">面接日時</th><td class="text-center"><?= h($res["interview_time"]) ?></td></tr>
</table>
    </div>
    <div class="col-sm-1"></div>
  </div>
