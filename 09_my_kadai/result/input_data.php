...
if($status==false){
  ...
  while( $result = $stmt->fetch(PDO::FETCH_ASSOC)){
    ...
    $view .= '<tr><th class="text-center">選考ステージ</th><td class="text-center">'.$interview_type[h($result["interview_type"])].'</td></tr>';
    $view .= '<tr><th class="text-center">面接日時</th><td class="text-center">'.h($result["interview_time"]).'</td></tr>';
    $view .= '</table>';
    $view .= '</div>';
  }
}
