...
try{
  ...
  $stmt1 = $pdo->prepare("UPDATE interview SET interview_type=:interview_type,interview_time=:interview_time WHERE id=:id");
  ...
  $stmt1->bindValue(':interview_time', $interview_time, PDO::PARAM_STR);  //Integer（数値の場合 PDO::PARAM_INT)
